...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.avatar','data' => ['avatarSrc' => $requestData->user->avatar_url,'name' => $requestData->user->name,'link' => route('admin.users.show', $requestData->user->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarSrc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($requestData->user->avatar_url),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($requestData->user->name),'link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.users.show', $requestData->user->id))]); ?>
...
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($requestData->status->label()); ?> <?php echo e($requestData->status->emoji()); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($requestData->created_at->getFormatted()); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.users.show', $requestData->user->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/authorship/index/parts/request-item.blade.php ENDPATH**/ ?>