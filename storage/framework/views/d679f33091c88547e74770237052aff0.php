                    ...
                    <table class="email-container" cellpadding="0" cellspacing="0" style="background-color: white; overflow: hidden;">
                        <tr>
                            <td style="padding: 16px 20px;">
                                <img src="<?php echo e($logotypeUrl); ?>" alt="Logo" style="display: block; max-height: 26px; margin: 0 auto;">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding: 20px; background-color: #333333;">
                                <div style="margin-bottom: 20px;">
                                    <span style="font-size: 12px; color: #ececec;">
                                        <?php echo e(__('email.post_scriptum', ['app_name' => config('app.name')])); ?>
                                ...
                                <div>
                                    <span style="font-size: 12px; color: #ececec;">
                                        <?php echo e(date('Y')); ?> &copy; <?php echo e(config('app.name')); ?>

                                    </span>
                                    <span style="font-size: 12px; color: #ececec;">
                                        <?php echo e(__('labels.all_rights_reserved')); ?>
...
</html><?php /**PATH /var/www/www.uservault.net/resources/views/emails/layouts/main.blade.php ENDPATH**/ ?>