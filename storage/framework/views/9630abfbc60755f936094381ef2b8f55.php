...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.avatar','data' => ['avatarSrc' => $productData->user->avatar_url,'name' => $productData->user->name,'link' => route('admin.users.show', $productData->user->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarSrc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productData->user->avatar_url),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($productData->user->name),'link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.users.show', $productData->user->id))]); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'strong','weight' => 'medium']); ?>
		<a href="<?php echo e(route('admin.market.show', $productData->id)); ?>" class="hover:underline whitespace-nowrap">
			<?php echo truncate_text($productData->title, 22); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($productData->created_at->getDate()); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.market.show', $productData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/market/index/parts/product-item.blade.php ENDPATH**/ ?>