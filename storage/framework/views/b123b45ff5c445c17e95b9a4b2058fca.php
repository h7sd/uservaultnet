...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ' '.e(__('admin/categories.show_title')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ' '.e(__('admin/categories.show_title')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
			<?php echo e(__('admin/categories.show_desc')); ?>
...
<?php $component->withAttributes([]); ?>
			 <?php $__env->slot('sideContent', null, []); ?> 
				<?php if (isset($component)) { $__componentOriginal8801e1bcbac0bb7a992699cd8157ce6b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8801e1bcbac0bb7a992699cd8157ce6b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.previews.category','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('entity.previews.category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal8801e1bcbac0bb7a992699cd8157ce6b)): ?>
<?php $attributes = $__attributesOriginal8801e1bcbac0bb7a992699cd8157ce6b; ?>
<?php unset($__attributesOriginal8801e1bcbac0bb7a992699cd8157ce6b); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal8801e1bcbac0bb7a992699cd8157ce6b)): ?>
<?php $component = $__componentOriginal8801e1bcbac0bb7a992699cd8157ce6b; ?>
<?php unset($__componentOriginal8801e1bcbac0bb7a992699cd8157ce6b); ?>
<?php endif; ?>
			 <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.header','data' => ['avatarUrl' => ''.e(asset('assets/icons/avatar/tag-01.png')).'','name' => ''.e($categoryData->category_name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarUrl' => ''.e(asset('assets/icons/avatar/tag-01.png')).'','name' => ''.e($categoryData->category_name).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.dropdown.item','data' => ['tag' => 'a','href' => ''.e(route('admin.categories.edit', $categoryData->id)).'','itemText' => ''.e(__('admin/dd.category.edit_category')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => ''.e(route('admin.categories.edit', $categoryData->id)).'','itemText' => ''.e(__('admin/dd.category.edit_category')).'']); ?>
...
<?php endif; ?>
							<?php if (isset($component)) { $__componentOriginal8ebfcb1ab4c7900b3fff763111e17423 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8ebfcb1ab4c7900b3fff763111e17423 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.dropdown.item','data' => ['tag' => 'a','danger' => true,'xOn:click' => 'deleteCategory','itemText' => ''.e(__('admin/dd.category.delete_category')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.dropdown.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','danger' => true,'x-on:click' => 'deleteCategory','itemText' => ''.e(__('admin/dd.category.delete_category')).'']); ?>
								 <?php $__env->slot('itemIcon', null, []); ?> 
									<?php if (isset($component)) { $__componentOriginalaa25fa354301adf40df60a26b9586efa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaa25fa354301adf40df60a26b9586efa = $attributes; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.title','data' => ['title' => ''.e(__('admin/categories.about_category')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('admin/categories.about_category')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.counter.counter-item','data' => ['counterValue' => ''.e($categoryData->category_name).'','captionText' => ''.e(__('table.labels.name')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['counterValue' => ''.e($categoryData->category_name).'','captionText' => ''.e(__('table.labels.name')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
					<?php if (isset($component)) { $__componentOriginal3c45f3cb213ca77b4e50dd08bd178c47 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.counter.counter-item','data' => ['counterValue' => ''.e($categoryData->usage_count).'','captionText' => ''.e(__('table.labels.usage')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('counter.counter-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['counterValue' => ''.e($categoryData->usage_count).'','captionText' => ''.e(__('table.labels.usage')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47)): ?>
<?php $attributes = $__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47; ?>
<?php unset($__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47); ?>
...
<?php endif; ?>
			...
			<div class="mb-4">
				<?php if (isset($component)) { $__componentOriginal6b435005e039a8c69512775c3a84f37f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6b435005e039a8c69512775c3a84f37f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.title','data' => ['title' => ''.e(__('admin/categories.category_translations')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('entity.title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('admin/categories.category_translations')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6b435005e039a8c69512775c3a84f37f)): ?>
<?php $attributes = $__attributesOriginal6b435005e039a8c69512775c3a84f37f; ?>
<?php unset($__attributesOriginal6b435005e039a8c69512775c3a84f37f); ?>
...
<?php endif; ?>
			...
			<?php if (! (empty($categoryData->localization))): ?>
				<div class="mb-6">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
						<?php $__currentLoopData = $categoryData->localization; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale => $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes([]); ?>
								 <?php $__env->slot('labelText', null, []); ?> 
									<span class="uppercase font-semibold"><?php echo e($locale); ?></span>
								 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
			...
			<?php else: ?>
				<div class="mb-6">
					<p class="text-par-s text-lab-sc text-center"><?php echo e(__('admin/categories.no_translations')); ?></p>
				</div>
			<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
					 ...
					 <?php $__env->endSlot(); ?>
					 <?php $__env->slot('labelValue', null, []); ?> 
						<?php echo e($categoryData->categorizable_type->label()); ?> <?php echo e($categoryData->categorizable_type->emoji()); ?>
...
<?php $component->withAttributes([]); ?>
					 ...
					 <?php $__env->endSlot(); ?>
					 <?php $__env->slot('labelValue', null, []); ?> 
						<?php echo e($categoryData->status->label()); ?> <?php echo e($categoryData->status->emoji()); ?>
...
<?php $component->withAttributes([]); ?>
					 <?php $__env->slot('labelText', null, []); ?> 
						<?php echo e(__('table.labels.depth')); ?>

					 <?php $__env->endSlot(); ?>
					 <?php $__env->slot('labelValue', null, []); ?> 
						<?php echo e($categoryData->depth); ?>
				...
				return {
					deleteCategory: () => {
						Alpine.store('confirmModal').open({
							title: "<?php echo e(__('admin/prompt.delete_category.title')); ?>",
							desc: "<?php echo e(__('admin/prompt.delete_category.description')); ?>",
							formAction: "<?php echo e(route('admin.categories.destroy', $categoryData->id)); ?>"
						});
					},
				}
			});
...
<?php echo $__env->make('adminLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/categories/show/index.blade.php ENDPATH**/ ?>