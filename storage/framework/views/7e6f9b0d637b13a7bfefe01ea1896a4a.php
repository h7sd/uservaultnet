...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.avatar','data' => ['avatarSrc' => $reportData->reporter->avatar_url,'name' => $reportData->reporter->name,'link' => route('admin.users.show', $reportData->reporter->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarSrc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($reportData->reporter->avatar_url),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($reportData->reporter->name),'link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.users.show', $reportData->reporter->id))]); ?>
...
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php if(isset($reportData->reason['description'])): ?>
			<a href="<?php echo e(route('admin.reports.show', $reportData->id)); ?>" class="hover:underline">
				<?php echo e(truncate_text($reportData->reason['description'], 32)); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.reports.show', $reportData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/reports/index/parts/report-item.blade.php ENDPATH**/ ?>