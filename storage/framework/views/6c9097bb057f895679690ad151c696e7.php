...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui-icon','data' => ['name' => 'tablet-02','type' => 'line']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'tablet-02','type' => 'line']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
			...
			<h4 class="text-title-2 text-lab-pr2 font-bold tracking-tighter mb-1">
				<?php echo e(__('switcher.desktop.title')); ?>

			</h4>
			<p class="text-par-l text-lab-sc mb-4">
				<?php echo e(__('switcher.desktop.description')); ?>

			</p>
		</div>
		<div class="px-6 pb-6">
			<a href="<?php echo e(route('device.switch', 'mobile')); ?>" class="block max-w-[400px] mx-auto">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.buttons.pill','data' => ['variant' => 'accent','btnText' => ''.e(__('switcher.desktop.button')).'','width' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'accent','btnText' => ''.e(__('switcher.desktop.button')).'','width' => 'w-full']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH /var/www/www.uservault.net/resources/views/components/device-switcher/desktop.blade.php ENDPATH**/ ?>