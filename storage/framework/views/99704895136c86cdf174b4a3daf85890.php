...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ' '.e(__('admin/config.verification_settings')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ' '.e(__('admin/config.verification_settings')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
			<?php echo e(__('admin/config.verification_settings_desc')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.config.env','data' => ['name' => 'VERIFICATION_SERVICE_URL','description' => ''.e(__('admin/config.captions.verification_service_url')).'','value' => ''.e(config('verification.service_url')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'VERIFICATION_SERVICE_URL','description' => ''.e(__('admin/config.captions.verification_service_url')).'','value' => ''.e(config('verification.service_url')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('adminLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/config/verification/index.blade.php ENDPATH**/ ?>