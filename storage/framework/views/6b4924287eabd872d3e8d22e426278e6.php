...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.format','data' => ['format' => 'ban']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['format' => 'ban']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
		...
		<h4 class="text-par-l font-semibold mb-1 text-lab-pr2">
			<?php echo __('admin/info.ban_notice.title'); ?>

		</h4>
		<p class="text-lab-sc text-par-s mb-2">
			<?php echo __('admin/info.ban_notice.line_one'); ?>

		</p>
		<p class="text-lab-sc text-par-s">
			<?php echo __('admin/info.ban_notice.line_two'); ?>

		</p>
		<p class="text-lab-sc text-par-s">
			<?php echo __('admin/info.ban_notice.line_three'); ?>
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/entity/previews/ban.blade.php ENDPATH**/ ?>