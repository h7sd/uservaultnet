...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ''.e(__('business/jobs.create_title')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ''.e(__('business/jobs.create_title')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('business.jobs.upsert', [
            'jobData' => $jobData,
            'upsertType' => 'create'
        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1675925821-1', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('businessLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/business/jobs/create.blade.php ENDPATH**/ ?>