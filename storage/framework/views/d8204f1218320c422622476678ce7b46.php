...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.format','data' => ['format' => 'catg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['format' => 'catg']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
		...
		<h4 class="text-par-l font-semibold mb-1 text-lab-pr2">
			<?php echo __('admin/info.category_notice.title'); ?>

		</h4>
		<p class="text-lab-sc text-par-s">
			<?php echo __('admin/info.category_notice.line_one'); ?>
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/entity/previews/category.blade.php ENDPATH**/ ?>