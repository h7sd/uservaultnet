...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.format','data' => ['format' => 'chat']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['format' => 'chat']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
		...
		<h4 class="text-par-l font-semibold mb-1 text-lab-pr2">
			<?php echo __('admin/info.chat_notice.title'); ?>

		</h4>
		<p class="text-lab-sc text-par-s mb-2">
			<?php echo __('admin/info.chat_notice.line_one'); ?>

		</p>
		<p class="text-lab-sc text-par-s mt-2">
			<?php echo __('admin/info.chat_notice.line_two'); ?>
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/entity/previews/chat.blade.php ENDPATH**/ ?>