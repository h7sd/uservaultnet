...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <?php if(theme_name() == 'dark'): ?>
            <link rel="stylesheet" href="<?php echo e(asset('build/assets/business-main-dark.css')); ?>?v=<?php echo e($buildNumber); ?>">
        <?php else: ?>
            <?php echo app('Illuminate\Foundation\Vite')('resources/css/business/main.css'); ?>
        <?php endif; ?>
    ...
    <body class="<?php echo \Illuminate\Support\Arr::toCssClasses(['pt-24', (theme_name() == 'dark' ? 'bg-black' : 'bg-fill-fv')]); ?>">
        <?php if(theme_name() == 'light'): ?>
            <img src="<?php echo e(asset('assets/backgrounds/modal-bg.png')); ?>" alt="Background" class="fixed opacity-50 w-full inset-0 -z-10">
        <?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <?php echo $__env->make('businessLayout::parts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    
            <?php echo $__env->make('businessLayout::parts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH /var/www/www.uservault.net/resources/views/layouts/mpa/apps/business/index.blade.php ENDPATH**/ ?>