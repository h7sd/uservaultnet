...
<?php $component->withAttributes(['variant' => 'strong','weight' => 'medium']); ?>
		<?php if($blacklistedContentData->admin): ?>
			<a href="<?php echo e(route('admin.users.show', $blacklistedContentData->admin->id)); ?>" class="hover:underline">
				<?php echo e($blacklistedContentData->admin->name); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'strong','weight' => 'medium']); ?>
		<a href="<?php echo e(route('admin.banning.show', $blacklistedContentData->id)); ?>" class="hover:underline">
			<?php echo e($blacklistedContentData->type->label()); ?> <?php echo e($blacklistedContentData->type->emoji()); ?>
...
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($blacklistedContentData->blacklistable); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($blacklistedContentData->added_at->getDate()); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php if($blacklistedContentData->expires_at): ?>
			<?php echo e($blacklistedContentData->expires_at->getDate()); ?>
...
<?php $component->withAttributes(['variant' => 'muted','numeric' => true]); ?>
		<?php echo e($blacklistedContentData->id); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.banning.show', $blacklistedContentData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/banning/index/parts/blacklisted-content-item.blade.php ENDPATH**/ ?>