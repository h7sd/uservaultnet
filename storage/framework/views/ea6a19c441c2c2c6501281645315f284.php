...
<?php endif; ?>
		...
		<h4 class="text-par-l font-semibold mb-1 text-lab-pr2">
			<?php echo __('admin/info.language_edit_notice.title'); ?>

		</h4>
		<p class="text-lab-sc text-par-s mb-2">
			<?php echo __('admin/info.language_edit_notice.line_one'); ?>

		</p>
		<p class="text-lab-sc text-par-s">
			<?php echo __('admin/info.language_edit_notice.line_two', ['documentation_url' => config('app.documentation_url')]); ?>
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/entity/previews/locale.blade.php ENDPATH**/ ?>