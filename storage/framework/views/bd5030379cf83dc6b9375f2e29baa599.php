...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ' '.e(__('admin/chats.show_title')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ' '.e(__('admin/chats.show_title')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
			<?php echo e(__('admin/chats.show_desc')); ?>
...
<?php $component->withAttributes([]); ?>
			 <?php $__env->slot('sideContent', null, []); ?> 
				<?php if($chatData->type->isDirect()): ?>
					<?php if (isset($component)) { $__componentOriginal034ace0e99a314c65cba198f30a9809e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal034ace0e99a314c65cba198f30a9809e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.previews.chat','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('entity.previews.chat'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal034ace0e99a314c65cba198f30a9809e)): ?>
<?php $attributes = $__attributesOriginal034ace0e99a314c65cba198f30a9809e; ?>
<?php unset($__attributesOriginal034ace0e99a314c65cba198f30a9809e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal034ace0e99a314c65cba198f30a9809e)): ?>
<?php $component = $__componentOriginal034ace0e99a314c65cba198f30a9809e; ?>
<?php unset($__componentOriginal034ace0e99a314c65cba198f30a9809e); ?>
<?php endif; ?>
				<?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.previews.group','data' => ['groupData' => $chatData->group]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['groupData' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($chatData->group)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.header','data' => ['avatarUrl' => ''.e(asset('assets/icons/avatar/message-chat-circle.png')).'','name' => ''.e($chatData->type->label()).' '.e($chatData->type->emoji()).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarUrl' => ''.e(asset('assets/icons/avatar/message-chat-circle.png')).'','name' => ''.e($chatData->type->label()).' '.e($chatData->type->emoji()).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.dropdown.item','data' => ['tag' => 'a','danger' => true,'xOn:click' => 'deleteChat','itemText' => ''.e(__('admin/dd.chat.delete_chat')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','danger' => true,'x-on:click' => 'deleteChat','itemText' => ''.e(__('admin/dd.chat.delete_chat')).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.counter.counter-item','data' => ['counterValue' => ''.e($chatData->participants_count).'','captionText' => ''.e(__('table.labels.participants')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['counterValue' => ''.e($chatData->participants_count).'','captionText' => ''.e(__('table.labels.participants')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
					<?php if (isset($component)) { $__componentOriginal3c45f3cb213ca77b4e50dd08bd178c47 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.counter.counter-item','data' => ['counterValue' => ''.e($chatData->messages_count).'','captionText' => ''.e(__('table.labels.messages')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('counter.counter-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['counterValue' => ''.e($chatData->messages_count).'','captionText' => ''.e(__('table.labels.messages')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47)): ?>
<?php $attributes = $__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47; ?>
<?php unset($__attributesOriginal3c45f3cb213ca77b4e50dd08bd178c47); ?>
...
<?php $component->withAttributes([]); ?>
							 <?php $__env->slot('labelText', null, []); ?> 
								<?php echo e(__('table.labels.participants')); ?>

							 <?php $__env->endSlot(); ?>
							 <?php $__env->slot('labelValue', null, []); ?> 
								<?php if($chatData->participants->count()): ?>
									<div class="flex flex-wrap gap-2">
										<?php $__currentLoopData = $chatData->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<a href="<?php echo e(route('admin.users.show', $participant->user->id)); ?>" target="_blank" class="underline">
								...
								<?php else: ?>
									<?php echo e(__('admin/chats.no_participants')); ?>
...
<?php $component->withAttributes([]); ?>
						 ...
						 <?php $__env->endSlot(); ?>
						 <?php $__env->slot('labelValue', null, []); ?> 
							<?php echo e($chatData->type->label()); ?> <?php echo e($chatData->type->emoji()); ?>
...
<?php $component->withAttributes([]); ?>
						 <?php $__env->slot('labelText', null, []); ?> 
							<?php echo e(__('table.labels.last_activity')); ?>

						 <?php $__env->endSlot(); ?>
						 <?php $__env->slot('labelValue', null, []); ?> 
							<?php if($chatData->last_activity): ?>
								<?php echo e($chatData->last_activity->getFormatted()); ?>
...
<?php $component->withAttributes([]); ?>
					 ...
					 <?php $__env->endSlot(); ?>
					 <?php $__env->slot('labelValue', null, []); ?> 
						<?php echo e($chatData->created_at->getFormatted()); ?>
				...
				return {
					deleteChat: () => {
						Alpine.store('confirmModal').open({
							title: "<?php echo e(__('admin/prompt.delete_chat.title')); ?>",
							desc: "<?php echo e(__('admin/prompt.delete_chat.description')); ?>",
							formAction: "<?php echo e(route('admin.chats.destroy', $chatData->id)); ?>"
						});
					}
				}
			});
...
<?php echo $__env->make('adminLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/chats/show/index.blade.php ENDPATH**/ ?>