...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
		<a href="<?php echo e(route('admin.chats.show', $chatData->id)); ?>" class="hover:underline">
			<?php if($chatData->type->isGroup()): ?>
				<?php echo e(($chatData->group) ? $chatData->group->name : __('labels.unknown')); ?> - <?php echo e(__('labels.chat_type_labels.group')); ?>
			...
			<?php else: ?>
				<?php if($chatData->participants->count()): ?>
					<?php $__currentLoopData = $chatData->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php echo e(($participant->user) ? $participant->user->name : __('labels.unknown')); ?>
					...
					- <?php echo e(__('labels.chat_type_labels.direct')); ?>
...
<?php endif; ?>
	...
	<?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['numeric' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['numeric' => true]); ?>
		<?php echo e($chatData->participants_count); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['numeric' => true]); ?>
		<?php echo e($chatData->messages_count); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.chats.show', $chatData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/chats/index/parts/chat-item.blade.php ENDPATH**/ ?>