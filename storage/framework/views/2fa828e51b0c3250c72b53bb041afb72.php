...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ' '.e(__('admin/config.api_settings')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ' '.e(__('admin/config.api_settings')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
			<?php echo e(__('admin/config.api_settings_desc')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.config.env','data' => ['name' => 'APP_API_KEY','description' => ''.e(__('admin/config.captions.api_key')).'','value' => ''.e(config('app.api_key')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'APP_API_KEY','description' => ''.e(__('admin/config.captions.api_key')).'','value' => ''.e(config('app.api_key')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('adminLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/config/api/index.blade.php ENDPATH**/ ?>