...
<div class="block">
    <?php if($backButton): ?>
        <a href="<?php echo e(url()->previous()); ?>" class="flex-center size-12 bg-bg-pr shadow-lg rounded-full mb-4 smoothing hover:text-brand-900">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui-icon','data' => ['name' => 'arrow-left','type' => 'solid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'arrow-left','type' => 'solid']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php endif; ?>
    <h2 class="text-title-1 tracking-tight text-lab-pr2 font-bold">
        <?php echo $titleText; ?>

    </h2>
</div><?php /**PATH /var/www/www.uservault.net/resources/views/components/page-title.blade.php ENDPATH**/ ?>