...
<?php $component->withAttributes([]); ?>
	<div class="overflow-hidden rounded-2xl">
		<div class="overflow-hidden">
			<img src="<?php echo e($userData->cover_url); ?>" alt="<?php echo e($userData->name); ?>" class="w-full">
		</div>
		<div class="p-4">
			<div class="size-14 overflow-hidden rounded-full border border-bord-pr">
				<img src="<?php echo e($userData->avatar_url); ?>" alt="<?php echo e($userData->name); ?>" class="size-full object-cover">
			</div>
			<div class="mb-4">
				...
				<?php if($userData->bio): ?>
					<p class="text-lab-sc text-par-s mt-2 leading-snug">
						<?php echo nl2br($userData->bio); ?>

					</p>
				<?php endif; ?>
			</div>

			<a href="<?php echo e($userData->profile_url); ?>" target="_blank">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/entity/previews/user.blade.php ENDPATH**/ ?>