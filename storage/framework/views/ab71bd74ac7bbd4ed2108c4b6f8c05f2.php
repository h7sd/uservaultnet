...
<a href="<?php echo e($link); ?>" class="bg-lab-pr2 rounded-full px-4 py-2 text-bg-pr" <?php echo e($attributes); ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui-icon','data' => ['name' => ''.e($iconName).'','type' => ''.e($iconType).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($iconName).'','type' => ''.e($iconType).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <span class="text-par-m leading-none font-medium"><?php echo e($btnText); ?></span>
    </span>
</a><?php /**PATH /var/www/www.uservault.net/resources/views/components/header-btn.blade.php ENDPATH**/ ?>