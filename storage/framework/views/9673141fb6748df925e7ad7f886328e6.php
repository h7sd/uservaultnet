...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity.format','data' => ['format' => 'env']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['format' => 'env']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
		...
		<h4 class="text-par-l font-semibold mb-1 text-lab-pr2">
			<?php echo e(__('admin/info.env_edit_notice.title')); ?>

		</h4>
		<p class="text-par-s text-lab-sc mb-2">
			<?php echo __('admin/info.env_edit_notice.line_one'); ?>

		</p>

		<p class="text-par-s text-lab-sc mb-4">
			<?php echo __('admin/info.env_edit_notice.line_two'); ?>

		</p>

		<div class="p-4 bg-fill-qt rounded-lg">
			<p class="text-par-s text-lab-pr2">
				<?php echo __('admin/info.env_edit_notice.env_privacy'); ?>
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/components/config/readonly-notice.blade.php ENDPATH**/ ?>