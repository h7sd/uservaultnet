...
<?php $component->withAttributes(['variant' => 'strong','weight' => 'medium']); ?>
		<a href="<?php echo e(route('admin.categories.show', $categoryData->id)); ?>" class="hover:underline">
...
<?php $component->withAttributes(['variant' => 'muted','numeric' => true]); ?>
		<?php echo e($categoryData->usage_count); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.categories.show', $categoryData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/categories/index/parts/category-item.blade.php ENDPATH**/ ?>