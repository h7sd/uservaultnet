...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth.parts.form-header','data' => ['title' => ''.e(__('auth.forgot_success_message.title')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('auth.forgot_success_message.title')).'']); ?>
...
<?php endif; ?>
                     ...
                     <?php $__env->slot('caption', null, []); ?> 
                        <?php echo e(__('auth.forgot_success_message.caption', ['email_address' => $confirmationData->email])); ?>
...
</div><?php /**PATH /var/www/www.uservault.net/resources/views/livewire/user/auth/forgot-success-form.blade.php ENDPATH**/ ?>