...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.avatar','data' => ['avatarSrc' => $postData->user->avatar_url,'name' => $postData->user->name,'link' => route('admin.users.show', $postData->user->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['avatarSrc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($postData->user->avatar_url),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($postData->user->name),'link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.users.show', $postData->user->id))]); ?>
...
<?php endif; ?>
		<?php else: ?>
			<a class="hover:underline" href="<?php echo e(route('admin.posts.show', $postData->id)); ?>">
				<?php echo e(truncate_text($postData->content, 22)); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($postData->comments_count); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'muted']); ?>
		<?php echo e($postData->views_count); ?>
...
<?php $component->withAttributes([]); ?>
		<div class="flex justify-end">
			<a href="<?php echo e(route('admin.posts.show', $postData->id)); ?>">
...
<?php endif; ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/posts/index/parts/post-item.blade.php ENDPATH**/ ?>