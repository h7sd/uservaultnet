...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['titleText' => ' '.e(__('admin/page.index_title')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titleText' => ' '.e(__('admin/page.index_title')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <?php echo e(__('admin/page.index_desc')); ?>
...
<?php endif; ?>
	...
	<div class="grid grid-cols-4 gap-4">
		<?php $__currentLoopData = config('pages.static'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
				<a href="<?php echo e(route('admin.pages.edit', ['pageName' => $page['name']])); ?>" class="p-4 h-56 relative block group cursor-pointer">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui-icon-avatar','data' => ['name' => ''.e($page['icon']).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($page['icon']).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
					<h4 class="font-semibold text-lab-pr2 mt-2">
						<?php echo e(__("admin/page.static_pages.{$page['name']}.title")); ?>

					</h4>
					<p class="text-par-n text-lab-sc">
						<?php echo e(__("admin/page.static_pages.{$page['name']}.description")); ?>
...
<?php echo $__env->make('adminLayout::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www.uservault.net/resources/views/apps/mpa/admin/pages/index/index.blade.php ENDPATH**/ ?>