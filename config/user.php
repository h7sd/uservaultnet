...
return [
    ...
    */
    ...
    'onboarding_steps' => [
        'profile' => [
            'component' => 'user.onboarding.profile',
            'is_skippable' => false, // Never change this for this step.
        ],
        'country' => [
            'component' => 'user.onboarding.country',
            'is_skippable' => true,
        ],
        'city' => [
            'component' => 'user.onboarding.city',
            'is_skippable' => true,
        ],
        'username' => [
            'component' => 'user.onboarding.username',
            'is_skippable' => false, // Never change this for this step.
        ],
    ]
];